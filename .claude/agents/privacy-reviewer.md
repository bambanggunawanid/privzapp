...
and currently sends nothing. Analytics were built once and deliberately
removed (ADR-0012, Reverted) — treat ANY re-introduction of a beacon,
counter or third-party script as a finding requiring explicit owner
sign-off. Your job is to find anything that erodes that.
